...
| [`智能旅行助手`](https://github.com/volcengine/agentkit-samples/tree/main/02-use-cases/travel_planner)              | ![label](https://img.shields.io/badge/%E8%BF%9B%E9%98%B6-CD853F) | 结合三方MCP Tool（高德）、联网搜索、知识库、记忆库，自动规划旅行行程；打通cozeloop支持评测。                                   |
