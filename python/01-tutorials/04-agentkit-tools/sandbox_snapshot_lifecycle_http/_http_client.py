...
class AgentKitToolsHttpClient:
    ...
    def call(self, action: str, body: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        query = {
            "Action": action,
            "Version": self.endpoint.api_version,
        }
        ...
        url = f"{self.endpoint.scheme}://{self.endpoint.host}/?{urlencode(query)}"
    ...
    def get_tool(self, body: dict[str, Any]) -> dict[str, Any]:
        return self.call("GetTool", body)
    ...
    def create_session_snapshot(self, body: dict[str, Any]) -> dict[str, Any]:
        return self.call("CreateSessionSnapshot", body)

    def get_session_snapshot(self, body: dict[str, Any]) -> dict[str, Any]:
        return self.call("GetSessionSnapshot", body)
    ...
    def delete_session_snapshot(self, body: dict[str, Any]) -> dict[str, Any]:
        return self.call("DeleteSessionSnapshot", body)

    def resume_session_from_snapshot(self, body: dict[str, Any]) -> dict[str, Any]:
        return self.call("ResumeSessionFromSnapshot", body)
