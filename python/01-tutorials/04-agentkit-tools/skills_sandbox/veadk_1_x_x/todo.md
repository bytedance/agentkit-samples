...
[ok], remote_registry + skills_sandbox: execute_skills 同步委托
...
[ok], remote_registry + aio_sandbox: run_code 代码执行
...
[ok], local_skills + runtime
[ok], remote_registry + runtime
[ok], local_skills + remote_registry + runtime

[不推荐，之后看需求再搞], local_skills + remote_registry + aio_sandbox
[不推荐，之后看需求再搞], local_skills + aio_sandbox
[不推荐，之后看需求再搞], local_skills + remote_registry + skills_sandbox
[不推荐，之后看需求再搞], local_skills + skills_sandbox
