...
# 1. Identity & Config
app_name = os.getenv("VEADK_APP_NAME", "ai_movie_studio_critic")
agent_name = os.getenv("VEADK_AGENT_NAME", "critic_agent")
description = os.getenv("VEADK_APP_DESCRIPTION", "AI Movie Studio 团队成员之一，毒舌影评人，负责视觉审计与质量评估")
