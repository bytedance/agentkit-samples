...
class DirectorAgentExecutor(A2aAgentExecutor):
    ...
    agent_card = AgentCard(
        ...
        skills=[
            AgentSkill(
                id="director_chat",
                name="director_chat",
                description="技术导演，Prompt编写与画面生成",
                tags=["chat", "director", "movie"],
            )
        ],
