...
agent_instance = screenwriter_agent
...
class ScreenwriterAgentExecutor(A2aAgentExecutor):
...
if __name__ == "__main__":
    agent_card = AgentCard(
        ...
        skills=[
            AgentSkill(
                id="screenwriter_chat",
                name="screenwriter_chat",
                description="剧本创作与分镜设计",
                tags=["chat", "screenwriter", "movie"],
            )
        ],
