...
class VePhoneClient:
        ...
        def walk(node: Any) -> Optional[str]:
            if isinstance(node, dict):
                for key, value in node.items():
                    if key.lower() in preferred_keys and isinstance(value, str) and value.startswith(('http://', 'https://')):
                        return value
    ...
    def _coerce_local_file_path(file_path: str) -> str:
        ...
        if scheme in {'http', 'https'}:
            raise ValueError('PushFile edge mode requires a local file path, not an HTTP URL')
        return file_path
    ...
    def detail_pod(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = {
    ...
    def delete_pod(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = {
            'ProductId': product_id or kwargs.pop('ProductId', self.product_id),
    ...
    def power_on_pod(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = {
            'ProductId': product_id or kwargs.pop('ProductId', self.product_id),
            'PodIdList': kwargs.pop('PodIdList', [pod_id]),
            **kwargs
    ...
    def power_off_pod(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = {
            'ProductId': product_id or kwargs.pop('ProductId', self.product_id),
            'PodIdList': kwargs.pop('PodIdList', [pod_id]),
            **kwargs
    ...
    def reboot_pod(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = {
            'ProductId': product_id or kwargs.pop('ProductId', self.product_id),
            'PodIdList': kwargs.pop('PodIdList', [pod_id]),
            **kwargs
    ...
    def reset_pod(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = {
            'ProductId': product_id or kwargs.pop('ProductId', self.product_id),
            'PodIdList': kwargs.pop('PodIdList', [pod_id]),
            **kwargs
    ...
    def create_pod_one_step(
        ...
        **kwargs
        ...
        body = self.compact_body(
            ...
            ResourceType=resource_type if resource_type is not None else self.resource_type,
            HostId=host_id,
    ...
    def backup_pod(self, pod_id_list: list[str], *, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            PodIdList=pod_id_list,
            **kwargs
    ...
    def cancel_backup_pod(self, pod_id_list: list[str], *, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            PodIdList=pod_id_list,
            **kwargs
    ...
    def cancel_restore_pod(self, pod_id_list: list[str], *, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            PodIdList=pod_id_list,
            **kwargs
    ...
    def pod_stop(self, pod_id: str, *, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            PodId=pod_id,
            **kwargs
    ...
    def get_proxy(self, pod_id_list: list[str], *, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            PodIdList=pod_id_list,
            **kwargs
    ...
    def install_app(self, pod_id: str, app_id: str, version_id: str, **kwargs) -> Dict[str, Any]:
        body = {
    ...
    def push_file(self, pod_id: str, file_url: str, phone_path: str, **kwargs) -> Dict[str, Any]:
        product_id = kwargs.pop('ProductId', self.product_id)
    ...
    def subscribe_resource_auto(self, **kwargs) -> Dict[str, Any]:
        ...
        if 'PreOrderList' not in kwargs:
            ...
            if int(resource_type) == 200 and not configuration_code:
                raise ValueError('ConfigurationCode is required for local-storage SubscribeResourceAuto')
        ...
        return self._json_request('SubscribeResourceAuto', body={
            'ProductId': product_id,
            **kwargs
        })

    def renew_resource_auto(self, **kwargs) -> Dict[str, Any]:
        return self._json_request('RenewResourceAuto', body={
            'ProductId': kwargs.pop('ProductId', self.product_id),
            **kwargs
        })
    ...
    def get_task_info(self, task_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('GetTaskInfo', json_body=True, ProductId=product_id or self.product_id, TaskId=task_id, **kwargs)
    ...
    def get_pod_metric(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('GetPodMetric', json_body=True, ProductId=product_id or self.product_id, PodId=pod_id, **kwargs)

    def get_pod_property(self, pod_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('GetPodProperty', json_body=True, ProductId=product_id or self.product_id, PodId=pod_id, **kwargs)

    def get_phone_template(self, phone_template_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('GetPhoneTemplate', ProductId=product_id or self.product_id, PhoneTemplateId=phone_template_id, **kwargs)
    ...
    def detail_host(self, host_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('DetailHost', ProductId=product_id or self.product_id, HostId=host_id, **kwargs)

    def update_host(self, host_id_list: List[str], configuration_code: Optional[str] = None, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self._json_request('UpdateHost', body=self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            HostIdList=host_id_list,
            ConfigurationCode=configuration_code,
            **kwargs
    ...
    def reboot_host(self, host_id_list: List[str], force: Optional[bool] = None, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self._json_request('RebootHost', body=self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            HostIdList=host_id_list,
            Force=force,
            **kwargs
    ...
    def reset_host(self, host_id_list: List[str], force: Optional[bool] = None, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self._json_request('ResetHost', body=self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            HostIdList=host_id_list,
            Force=force,
            **kwargs
    ...
    def list_image_resources(self, offset: int = 0, count: int = 10, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('ListImageResource', ProductId=product_id or self.product_id, Offset=offset, Count=count, **kwargs)
    ...
    def get_dc_bandwidth_daily_peak(
        ...
        **kwargs
        ...
        if (
            len(dc_id_list) == 1
            and isinstance(dc_id_list[0], list)
        ):
    ...
    def list_display_layouts(self, offset: int = 0, count: int = 10, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('ListDisplayLayoutMini', ProductId=product_id or self.product_id, Offset=offset, Count=count, **kwargs)

    def detail_display_layout(self, display_layout_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('DetailDisplayLayoutMini', ProductId=product_id or self.product_id, DisplayLayoutId=display_layout_id, **kwargs)
    ...
    def detail_app(self, app_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('DetailApp', ProductId=product_id or self.product_id, AppId=app_id, **kwargs)
    ...
    def delete_app(self, *, app_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(ProductId=product_id or self.product_id, AppId=app_id, **kwargs)
        return self._json_request('DeleteApp', body=body)

    def delete_app_version(self, *, version_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(ProductId=product_id or self.product_id, VersionId=version_id, **kwargs)
    ...
    def list_app_version_deploys(self, app_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('ListAppVersionDeploy', ProductId=product_id or self.product_id, AppId=app_id, **kwargs)
    ...
    def get_app_crash_log(
        ...
        **kwargs
        ...
        pod_id_value = ','.join(pod_id_list) if isinstance(pod_id_list, list) else pod_id_list
        return self.request_action(
            'GetAppCrashLog',
            ProductId=product_id or self.product_id,
    ...
    def list_tags(self, offset: int = 0, count: int = 10, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('ListTag', ProductId=product_id or self.product_id, Offset=offset, Count=count, **kwargs)
    ...
    def list_port_mapping_rules(self, offset: int = 0, count: int = 10, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('ListPortMappingRule', ProductId=product_id or self.product_id, Offset=offset, Count=count, **kwargs)

    def detail_port_mapping_rule(self, port_mapping_rule_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('DetailPortMappingRule', ProductId=product_id or self.product_id, PortMappingRuleId=port_mapping_rule_id, **kwargs)
    ...
    def list_dns_rules(self, offset: int = 0, count: int = 10, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('ListDNSRule', json_body=True, ProductId=product_id or self.product_id, Offset=offset, Count=count, **kwargs)

    def detail_dns_rule(self, dns_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        return self.request_action('DetailDNSRule', json_body=True, ProductId=product_id or self.product_id, DNSId=dns_id, **kwargs)
    ...
    def delete_dns_rule(self, *, dns_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            DNSId=dns_id,
            **kwargs
    ...
    def delete_custom_route(self, *, custom_route_id: str, product_id: Optional[str] = None, **kwargs) -> Dict[str, Any]:
        body = self.compact_body(
            ProductId=product_id or kwargs.pop('ProductId', self.product_id),
            CustomRouteId=custom_route_id,
            **kwargs
