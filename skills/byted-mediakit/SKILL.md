---
name: byted-mediakit
description: "Volcengine AI MediaKit audio and video processing skill. It is triggered when users need to process or edit audio/video content. After processing, it automatically checks task status and returns playback links for the generated outputs. Core capabilities are grouped into five categories: 1) Video processing: multi-clip stitching, clip trimming, frame flipping, video speed adjustment, audio speed adjustment, image-to-video generation, audio-video composition, audio track extraction, and audio mixing; 2) Audio processing: vocal/accompaniment separation and audio noise reduction; 3) Video enhancement: comprehensive quality restoration, AI super-resolution, and intelligent frame interpolation; 4) AI content analysis: ASR speech-to-text, OCR text extraction, subtitle removal, subtitle embedding, intelligent scene slicing, portrait matting, green screen matting, media info query, and highlight extraction; 5) AI content generation: comic style transfer, AI video translation, AI drama recap narration, and AI drama script restoration. Trigger keywords: video stitching, video trimming, video editing, video speed change, video flipping, image to video, audio-video composition, audio extraction, mixing, vocal separation, background sound separation, audio denoise, denoise, AI super-resolution, super resolution, quality restoration, quality enhancement, intelligent frame interpolation, video frame interpolation, frame rate increase, speech recognition, ASR, OCR, text extraction, subtitle removal, subtitle erasure, add subtitle, embed subtitle, scene segmentation, scene slicing, portrait matting, green screen, highlight, comic style, video translation, drama recap, drama narration, drama script, script restoration, media info. Not applicable to: pure text generation, real-time streaming processing, video understanding/analysis (except supported AI features), and AI generative video creation without source media inputs."
version: 1.0.4
env:
